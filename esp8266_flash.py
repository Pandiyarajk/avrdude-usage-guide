...
def main():
    parser = argparse.ArgumentParser(description='ESP8266 NodeMCU Flashing Tool')
    parser.add_argument('--port', required=True, help='Serial port (e.g., COM3, /dev/ttyUSB0)')
    parser.add_argument('--baud', type=int, default=115200, help='Baud rate (default: 115200)')
    parser.add_argument('--action', required=True, choices=['info', 'read', 'write', 'erase', 'backup'], 
    ...
    flasher = ESP8266Flasher(args.port, args.baud)
